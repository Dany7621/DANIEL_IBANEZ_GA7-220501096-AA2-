 ...
 * @author usuario
 */
public class DELETE_ProyectoIsad {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(DELETE_ProyectoIsad.class.getName()).log(Level.SEVERE, null, ex); // en caso de que no jale
        }
        ...
        try {
            ...
            statement.executeUpdate("DElETE FROM productos WHERE pieza='anillo admision'"); //update es el que realiza operaciones
            ...
            Logger.getLogger(DELETE_ProyectoIsad.class.getName()).log(Level.SEVERE, null, ex);
        }
